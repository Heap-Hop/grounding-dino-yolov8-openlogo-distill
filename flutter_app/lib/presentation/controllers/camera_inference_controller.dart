...
class CameraInferenceController extends ChangeNotifier {
  ...
  // Model state
  ModelType _selectedModel = ModelType.humanLabels;
  ...
  //https://github.com/ultralytics/yolo-flutter-app/issues/360#issuecomment-3435635736
  void onStreamingData(Map<String, dynamic> data) {
    ...
    final count = (data['detections'] as List?)?.length ?? 0;

    if (_detectionCount != count) {
